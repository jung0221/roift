...
static char * gni_history[] = 
{
  ...
  "   - included Mark's changes in the AFNI distribution (including znzlib1/)\n"
  ...
  "   - added nifti_brick_list type to nifti2_io.h, along with new prototypes\n"
  ...
  "   - in nifti2_io.h, removed znzlib1 directory from include - all nifti\n"
  ...
  "   - nifti2_io.h: added doxygen comments for file and nifti_image struct\n"
  "   - nifti2_io.h: added doxygen comments for file and some functions\n"
  "   - nifti2_io.c: changed nifti_copy_nim_info to use memcpy\n"
  "\n",
  "1.3  09 Feb 2005 [rickr]\n"
  "   - nifti1.h: added doxygen comments for extension structs\n"
  "   - nifti2_io.h: put most #defines in #ifdef _nifti2_io_C_ block\n"
...
/*! check whether nifti_type matches fname and iname for the nifti_image
    ...
    \sa NIFTI_FTYPE_* codes in nifti2_io.h
...
/*! nifti_add_extension - add an extension, with a copy of the data
   ...
   \sa extension codes NIFTI_ECODE_* in nifti2_io.h
